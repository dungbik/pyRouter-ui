...
class MyWindow(QMainWindow, form_class):
    ...
    def btn_ForwardingInsertButtonClicked(self):
        ...
        self.InsertForwardingTable(self.ForwardingDestinationEdit.text(),self.ForwardingNetmaskEdit.text(),self.ForwardingGatewayEdit.text(),Flag,self.ForwardingInterfaceEdit.text(),self.ForwardingMetricEdit.text())
